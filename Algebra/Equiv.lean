...
instance : QuotLike r (EquivUnchecked r) where
  mk := EquivUnchecked.mk _
  unwrapQuot := EquivUnchecked.get
  mk_unwrapQuot := EquivUnchecked.mk_get
  ind := EquivUnchecked.ind
  sound := EquivUnchecked.sound _

instance : QuotientLike s (Equiv s) where
  mk := EquivUnchecked.mk _
  unwrapQuot := EquivUnchecked.get
  mk_unwrapQuot := EquivUnchecked.mk_get
  ind := EquivUnchecked.ind
  sound := EquivUnchecked.sound _
  exact := Equiv.exact _ _
